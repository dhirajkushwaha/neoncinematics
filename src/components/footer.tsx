...
export default function Footer() {
    return (
        // <div classNameName="bg-[#181717] mt-[80px]" >
        //     <div classNameName="mx-auto w-[80vw] xl:w-[1024px] mx-auto py-[30px] flex flex-col items-center" >
        //         <img width={"220px"}   classNameName=" mix-blend-exclusion rounded-[10px] " src="./assets/images/neonlogo.jpg" alt="" />

        //         <p classNameName="text-2xl" style={{fontFamily:"polysans"}} >The official Cinematic Club of IIIT Kota</p> 

        //     </div>
        // </div>


        <footer className="w-full py-14 text-white bg-[#171717] DMSans mt-20" >
            <div className="mx-auto max-w-7xl   px-4 sm:px-6 lg:px-8" >
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="flex space-x-10 justify-center items-center mb-14">
                        {/* <a href="https://www.instagram.com/neoncinematics/" className="block  text transition-all duration-500 hover:text-[#bbbbbb] ">
                        ...
                        <a href="https://www.instagram.com/neoncinematics/" target="_blank" className="block  text transition-all duration-500 hover:text-[#bbbbbb] ">
                        ...
                        <a href="https://www.youtube.com/@neonfilmandmaking" target="_blank" className="block  text transition-all duration-500 hover:text-[#bbbbbb] ">
