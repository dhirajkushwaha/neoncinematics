      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto DMSans">
        ...
        <div className="grid grid-cols-1 lg:w-[800px] mx-auto lg:grid-cols-2 gap-8 md:gap-8">
          <div className="text-center">
            <img className="rounded-xl sm:size-80 lg:size-80 mx-auto" src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80" alt="Avatar" />
            <div className="mt-2 sm:mt-4">
              <h3 className=" text-xl font-medium    lg:text-lg ">
                Tanveer Singh
              </h3>
        ...
        <div className="max-w-2xl mt-20 mx-auto text-center mb-10 lg:mb-14">
          <h2 className="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white polysans">Team Members & Leads</h2>
        </div>
        {/* End Title */}
